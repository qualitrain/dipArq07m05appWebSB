...
public class ConfiguracionSeguridad {
    ...
    @Bean
    public DataSource seguridadDataSource(@Qualifier("seguridadProperties")
                                          DataSourceProperties seguridadProperties) {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .addFilterAfter(new FiltroMonitoreoWeb(servicioMonitoreo), SecurityContextHolderAwareRequestFilter.class);
    ...
    UserDetailsManager getGestorBdUsuarios(@Qualifier("seguridadDataSource") DataSource dataSource) {
        UserDetails usuarioAlex = User.withUsername("alex")
                                    .password("{bcrypt}$2a$10$YCRvR3nqYDHuojZsg4W.AejFi5gGv..4U/Ne4qexYanAFFfBQfN3q").roles("USER","AGENTE","ADMIN")
                                    .build();
